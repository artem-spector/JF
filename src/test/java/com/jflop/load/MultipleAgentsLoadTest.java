...
public class MultipleAgentsLoadTest extends LoadTestBase {
    ...
    protected void startAgents(int... numFlows) throws Exception {
        ...
        for (int agentNumFlows : numFlows) {
            ...
            long duration = awaitFeatureResponse(agentJVM, JvmMonitorFeature.FEATURE_ID, System.currentTimeMillis(), 10);
            logger.info(agentName + " monitoring started in " + duration + " ms.");
        }
    }
